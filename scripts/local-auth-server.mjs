...
const routes = new Map([
  ...
  ["/api/physical/auth", path.join(root, "api/physical/[action].js")],
  ["/api/physical/listings", path.join(root, "api/physical/[action].js")],
  ["/api/physical/supporter", path.join(root, "api/physical/[action].js")],
  ["/api/physical/supporter-webhook", path.join(root, "api/physical/[action].js")],
